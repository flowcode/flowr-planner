...
namespace Flower\ModelBundle\Tests\Controller\Planner;

use Symfony\Bundle\FrameworkBundle\Test\WebTestCase;

class EventStatusControllerTest extends WebTestCase
{
    public function testCreate()
    {
        $client = static::createClient();
        $crawler = $client->request('GET', '/planner_eventstatus/');
        ...
        $form = $crawler->filter('form button[type="submit"]')->form(array(
            'eventstatus[name]' => 'Lorem ipsum dolor sit amet',
            'eventstatus[description]' => 'Lorem ipsum dolor sit amet',
                    ));
        $client->submit($form);
    ...
    {
        $client = static::createClient();
        $crawler = $client->request('GET', '/planner_eventstatus/new');
    ...
    public function testEdit()
    {
        ...
        $form = $crawler->filter('form button[type="submit"]')->form(array(
            'eventstatus[name]' => 'Changed',
            'eventstatus[description]' => 'Changed',
